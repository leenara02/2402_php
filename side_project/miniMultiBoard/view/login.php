...
<body>
    ...
    <div class="login-box position-absolute top-50 start-50 translate-middle">
        <form action="/user/login" method="POST">
            <div class="mb-3">
                <div id="passwordHelpBlock" class="form-text text-danger">에러에러에러</div>
                <label for="u_email" class="form-label">이메일</label>
                <input type="text" class="form-control" style="width: 300px;" id="u_email" name="u_email" required>
            </div>
            <div class="mb-3">
                <label for="u_pw" class="form-label">비밀번호</label>
                <input type="password" id="u_pw" class="form-control" name="u_pw" aria-describedby="passwordHelpBlock" required>
            </div>
            <div class="mb-3">
